...
class IniFile0v1:
	...
	def write(self, filename=None):
		...
		simulationSettings.params['outputScriptName']    = self.form.outputScriptName.text()
	...
	def read(self, filename=None):
		...
		for settingsGroup in settings.childGroups():
			...
			if (re.compile("EXCITATION").search(settingsGroup)):
				...
				self.form.outputScriptName.setText(simulationSettings.getValue("outputScriptName"))
